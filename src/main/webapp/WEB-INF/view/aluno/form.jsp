...
<body class="container">
	...
	<form action="/sgedu/alunos/add" method="post">
	  ...
	  <div class="col">
			...
			<input type="text" class="form-control" id="forCPF" placeholder="Enter CPF" name="cpf"> 
	  ...
	  <br>
		...
		<div class="col">
			...
			<input type="text" class="form-control" id="forTelefone" placeholder="Enter Phone" name="telefone"> 
		</div>
	  <div class="col">
